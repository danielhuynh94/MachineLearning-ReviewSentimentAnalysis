...
class Bayes_Classifier:
    ...
    def __init__(self, trainDirectory="movies_reviews/"):
        ...
        exists = os.path.isfile('positiveReviewUnigrams') and os.path.isfile(
            'negativeReviewUnigrams') and os.path.isfile('trainingDataAttributes')
    ...
    def train(self):
        ...
        self.save({"probPositiveDocument": self.probPositiveDocument,
                   ...
                   "sumNegativeUnigramFrequencies": self.sumNegativeUnigramFrequencies}, "trainingDataAttributes")
